...
public class D07LocateByXpath_Facebook {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/div/div/div/div/div/div/div[2]/div/div/form/div/div[2]/div/input")).sendKeys("123456");
